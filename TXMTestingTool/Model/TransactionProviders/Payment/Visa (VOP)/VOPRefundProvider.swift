...
struct VOPRefundTransaction: Codable {
    ...
    init(withTransaction transaction: Transaction, forMerchant merchant: MerchantAgent, transactionDateFormatter: DateFormatter, merchantPurchaseDateFormatter: DateFormatter) {
        ...
        messageElementsCollection = [
            ...
            VOPElement("ReturnTransaction.DateTime", merchantDate),                    // The local date (no time) of the transaction.
